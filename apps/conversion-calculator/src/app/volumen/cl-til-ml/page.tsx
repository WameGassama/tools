...
const DESCRIPTION =
  "Omregn cl til ml online hurtigt og nemt. Se en cl til ml tabel, eller indtast din egen værdi."
...
const ML_PER_CL = 10
const COMMON_CL_VALUES = [1, 2, 3, 4, 5, 10]

const FAQ_ITEMS = [
  {
    question: "Hvordan omregner man cl til ml?",
    answer:
      "Formlen er ml = cl × 10. Fx bliver 4 cl til ml: 4 × 10 = 40 ml.",
  },
  {
  ...
  {
    question: "Hvad er en cl?",
    answer:
      "Cl er en forkortelse for centiliter, en enhed for rumfang på 1/100 liter, altså 10 ml.",
  },
]
    ...
    <div className="flex flex-1 flex-col bg-muted">
      ...
      <section className="mx-auto w-full max-w-5xl px-4 pt-10 pb-10 sm:px-6 sm:pt-14 sm:pb-18">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 via-primary to-blue-700 px-6 py-14 text-primary-foreground shadow-2xl ring-1 shadow-primary/30 ring-white/10 sm:px-12 sm:py-20">
          ...
          <div className="relative max-w-xl">
            ...
            <p className="text-base leading-relaxed text-primary-foreground/70 sm:text-base">
              Brug vores cl til ml omregner til hurtigt og nemt at omregne
              centiliter til milliliter. Indtast det antal centiliter, du vil
        ...
        <div className="mt-8 rounded-2xl border bg-background p-6 shadow-sm sm:p-8">
          ...
          <ul className="grid gap-x-8 gap-y-3 sm:grid-cols-2 lg:grid-cols-3">
            {COMMON_CL_VALUES.map((cl) => (
              ...
              >
                <h3 className="font-semibold">{cl} cl til ml</h3>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/volumen/ml-til-cl" className="text-primary underline">
            Omregn ml til cl
          </Link>
        </p>
      </section>
