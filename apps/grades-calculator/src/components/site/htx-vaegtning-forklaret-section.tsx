...
const NIVEAU_ROWS = [
  { niveau: "A-niveau", weight: "2", note: "fx Dansk A, Teknikfag A" },
  { niveau: "B-niveau", weight: "1,5", note: "fx Matematik B, Fysik B" },
  { niveau: "C-niveau", weight: "1", note: "fx Biologi C, Samfundsfag C" },
]
    ...
    <section className="mx-auto w-full max-w-3xl px-6 pt-8 pb-12 sm:pb-16">
      ...
      <div className="mt-8 rounded-xl border bg-background p-6 sm:p-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          givet. Grundforløbsfag som naturvidenskabeligt grundforløb og
          produktudvikling tæller med som almindelige fag på deres eget
          niveau.
        </p>
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <p className="mt-2 leading-relaxed text-muted-foreground">
            Dansk A (karakter 7), Teknikfag A (karakter 10) og Matematik B
            (karakter 4) giver
        ...
        <KilderSektion>
          <Regelgrundlag
            items={[
              ...
              {
                href: "https://uvm.dk/uddannelse-til-unge/gymnasiale-uddannelser/uddannelser/hoejere-teknisk-eksamen-htx/",
                title: "uvm.dk: Htx-uddannelsen",
