...
const NIVEAU_ROWS = [
  { niveau: "A-niveau", weight: "2", note: "fx Dansk A, Historie A" },
  { niveau: "B-niveau", weight: "1,5", note: "fx Engelsk B" },
  { niveau: "C-niveau", weight: "1", note: "fx Idræt C, Religion C" },
]

const FIXED_WEIGHT_ROWS = [
  { fag: "Studieretningsprojekt (SRP)", weight: "2" },
]
...
export function StxVaegtningForklaretSection() {
  return (
    <section className="mx-auto w-full max-w-3xl px-6 pt-8 pb-12 sm:pb-16">
      <h2 className="text-[26px] font-extrabold">
        Sådan beregnes dit STX snit
      </h2>
      <p className="mt-2 text-muted-foreground">
        I modsætning til et simpelt gennemsnit vægtes dine karakterer på
        STX&apos;s eksamensbevis efter fagets niveau. Har du mange fag på
        A-niveau, kan du få et tillæg til dit STX snit.
      </p>
      ...
      <div className="mt-8 rounded-xl border bg-background p-6 sm:p-8">
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            SRP har altid vægt 2, uanset niveau, og tæller ikke med som et af
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <p className="mt-2 leading-relaxed text-muted-foreground">
            Dansk A (karakter 7), Matematik A (karakter 10) og Engelsk B
            (karakter 4) giver
        ...
        <KilderSektion>
          <Regelgrundlag
            items={[
              ...
              {
                href: "https://uvm.dk/uddannelse-til-unge/gymnasiale-uddannelser/uddannelser/studentereksamen-stx/",
                title: "uvm.dk: Stx-uddannelsen",
